...
public:
    ...
    // Explicitely prevent move/copy construction/assignment
    // (the uWS::Hub member cannot be moved/copied, since it would occupy the same TCP port)
