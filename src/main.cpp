...
int main()
{
    ...
    driver.SetMaxIterations(1000);

    // Set initial PID coefficient values
    driver.ConfigureSteeringPID(0.17, 0.0001, 1.8);
    driver.ConfigureThrottlePID(2.5,  0.0001, 4.0);
...
//  return EXIT_SUCCESS;
    ...
    std::vector<double> pid_params{0.17, 0.0001, 1.8, 2.5, 0.0001, 4.0};
    std::vector<double> pid_deltas{0.01, 0.0,    0.1, 0.1, 0.0,    0.1};
